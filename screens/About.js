//imports for UI - react native attributes
...
//dial function to determine operating system
//and link to the correct phone app to call rodeo town 
//taxi dispatch
const dial = () => {
...
class About extends React.Component {
  ...
  //displays information about the company rodeo town 
  //taxi, and allows a clickable call button to reach out
  //to dispatch
  render() {
    return (
      <View>
...
//style sheet for the About.js page and its components
