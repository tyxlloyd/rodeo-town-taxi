  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <TextInput placeholder="Email" style={styles.loginInput} onChangeText={text => this.setState({ email: text })} />
        <TextInput placeholder="Phone Number" style={styles.loginInput} onChangeText={text => this.setState({ phoneNumber: text })} />
